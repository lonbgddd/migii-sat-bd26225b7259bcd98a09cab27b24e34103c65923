...
class PracticeQuestionItem extends BasePage {
  int posQuestion;
  ...
  PracticeQuestionItem(this.posQuestion, this.questionObject,
...
class _State extends BasePageState<PracticeQuestionItem>
  ...
  Widget _answerTopItem(int index, QuestionContent contentObject, String answer,
    ...
    return Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
      GestureDetector(
        onTap: () {
          if (yourAnswer > 0 || widget.isShowAnswer || isChoiceAnswerBottom) {
            return;
          }
          setState(() {
                  ...
                  : (yourAnswer > 0
                      ? (yourAnswer == index + 1
                          ...
                          : (correct == index + 1
                              ? ColorHelper.colorPrimary
                              : Colors.transparent))
                      : (widget.isShowAnswer && correct == index + 1
                          ? ColorHelper.colorPrimary
                          : Colors.transparent))),
          ...
          if (answerTotal > 0)
            for (var index = 0; index < answerTotal; index++) ...{
              Expanded(
                ...
                onTap: () {
                  if (yourAnswer > 0 || widget.isShowAnswer) return;
                  setState(() {
                    contentObject.yourAnswer = index + 1;
                  });
                  _chooseAnswerListener(currentQuestionChild,
