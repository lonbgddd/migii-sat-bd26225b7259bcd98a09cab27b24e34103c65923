...
class PracticeQuitDialog extends BasePage {
  final VoidCallback quitListener;

  const PracticeQuitDialog(this.quitListener, {Key? key}) : super(key: key);

  @override
  BasePageState<BasePage> createState() => _State();

  static show(BuildContext context, VoidCallback quitListener) {
    showGeneralDialog(
        barrierLabel: "PracticeQuitDialog",
        ...
        pageBuilder: (context, anim1, anim2) {
          return Align(
              ...
              child: PracticeQuitDialog(quitListener));
        },
...
class _State extends BasePageState<PracticeQuitDialog> {
  @override
  ...
  Column viewContainer() {
    return Column(
        ...
        children: [
          ...
          Padding(
            padding:
                EdgeInsets.fromLTRB(16.0.dp(), 4.0.dp(), 16.0.dp(), 16.0.dp()),
            child: Text(
              appLocalized().mess_confirm_back,
