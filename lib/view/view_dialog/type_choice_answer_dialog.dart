...
class TypeChoiceAnswerDialog extends BasePage {
  int typeChoice;
  Function(int typeChoice) chooseListener;

  TypeChoiceAnswerDialog(this.typeChoice, this.chooseListener, {super.key});

  @override
  BasePageState<BasePage> createState() => _State();

  static show(BuildContext context, int typeChoice,
      Function(int typeChoice) chooseListener) {
    showGeneralDialog(
        barrierLabel: "TypeChoiceAnswerDialog",
        ...
        pageBuilder: (context, anim1, anim2) {
          return Align(
              ...
              child: TypeChoiceAnswerDialog(typeChoice, chooseListener));
        },
...
class _State extends BasePageState<TypeChoiceAnswerDialog> {
  ...
  void initState() {
    super.initState();
    listItem = [appLocalized().bottom_screen, appLocalized().above_the_topic];
    ...
    return Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        child: Row(children: [
          ...
          Flexible(
            ...
            child: GestureDetector(
              onTap: () {
                Navigator.pop(context);
                widget.chooseListener(typeChoice);
              },
              child: Container(
                height: double.infinity,
                width: double.infinity,
      ...
      Container(
        ...
        child: CupertinoPicker(
          itemExtent: 36.0.dp(),
          scrollController:
              FixedExtentScrollController(initialItem: typeChoice),
          children: [
