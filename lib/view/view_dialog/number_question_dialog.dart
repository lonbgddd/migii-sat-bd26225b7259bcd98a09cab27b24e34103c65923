...
class NumberQuestionDialog extends BasePage {
  int maxQuestion;
  int numberQuestion;
  Function(int number) chooseListener;

  NumberQuestionDialog(
      this.maxQuestion, this.numberQuestion, this.chooseListener,
      {super.key});

  @override
  BasePageState<BasePage> createState() => _State();

  static show(BuildContext context, int maxQuestion, int numberQuestion,
      Function(int number) chooseListener) {
    showGeneralDialog(
        barrierLabel: "NumberQuestionDialog",
        ...
        pageBuilder: (context, anim1, anim2) {
          return Align(
              ...
              child: NumberQuestionDialog(
                  maxQuestion, numberQuestion, chooseListener));
        },
...
class _State extends BasePageState<NumberQuestionDialog> {
  ...
  void initState() {
    super.initState();
    for (var index = 1; index <= widget.maxQuestion; index++) {
      listItem.add("$index");
    }
    numberChoose = widget.numberQuestion;
  }
      ...
      Container(
        ...
        child: Row(children: [
          ...
          Flexible(
              ...
              child: Center(
                child: AutoSizeText(
                  appLocalized().choose_number_question,
          ...
          Flexible(
            ...
            child: GestureDetector(
              onTap: () {
                Navigator.pop(context);
                widget.chooseListener(numberChoose);
              },
              child: Container(
                height: double.infinity,
                width: double.infinity,
      ...
      Container(
        ...
        child: CupertinoPicker(
          ...
          scrollController: FixedExtentScrollController(
              initialItem: widget.numberQuestion - 1),
          children: [
          ...
          onSelectedItemChanged: (int value) {
            numberChoose = int.tryParse(listItem[value]) ?? 1;
          },
        ),
      )
    ]);
