...
class ExamQuestionItem extends BasePage {
  int posQuestion;
  ExamCellObject? examObject;
  int currentQuestion;
  Function(int currentQuestion, bool isNextQuestion)? setAnswerChooseListener;

  ExamQuestionItem(this.posQuestion, this.examObject, this.currentQuestion,
...
class _State extends BasePageState<ExamQuestionItem>
