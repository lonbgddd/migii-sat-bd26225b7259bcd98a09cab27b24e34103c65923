...
class ExamPracticeQuestionGridInsItem extends BasePage {
  int posQuestion;
  ExamCellObject? examObject;
  int currentQuestion;
  Function(int currentQuestion, bool isNextQuestion)? setAnswerChooseListener;

  ExamPracticeQuestionGridInsItem(this.posQuestion, this.examObject,
...
class _State extends BasePageState<ExamPracticeQuestionGridInsItem>
  ...
  void initState() {
    ...
    answerEnterList =
        List.filled(questionObject?.content?.length ?? 0, "");
  ...
  Widget build(BuildContext context) {
    ...
    // Log.all("questionObject: ${jsonEncode(questionObject)}");
        ...
        child: SizedBox(
            ...
            child: Column(
              ...
              children: [
                ...
                if ((!yourAnswerGridIns.isNullOrEmpty) &&
